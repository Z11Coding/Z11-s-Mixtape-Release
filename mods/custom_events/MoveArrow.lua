...
function onEvent(name, value1, value2)
    if name == "MoveArrow" then
        ...
        if value1 < 4 then
            notePosX = getPropertyFromGroup('strumLineNotes', value1, 'x');
            notePosY = getPropertyFromGroup('ostrumLineNotes', value1, 'y');
        else
            notee = value1 - 4;
            notePosX = getPropertyFromGroup('strumLineNotes', notee, 'x');
            notePosY = getPropertyFromGroup('strumLineNotes', notee, 'y');
        end
